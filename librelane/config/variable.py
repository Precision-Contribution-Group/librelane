...
class MacroGrid:
    ...
    """
    coord_bl: Tuple[Decimal, Decimal]
    size: Decimal
    inst_pad_x: Decimal
    inst_pad_y: Decimal
...
class Macro:
    ...
    :param macro_grid: If defined, this macro and its instances will be autoplaced into the grid as declared.
    See Odb.MacroGridAutoplacer for more info.
    """
    ...
    macro_grid: Optional[MacroGrid] = None
