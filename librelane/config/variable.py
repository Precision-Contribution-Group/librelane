...
class MacroGrid:
    """
    A grid of macros for use in the grid macro autoplacer (see Odb.GridMacroAutoplacer).

    :param name: The name of this macro grid.
    :param coord_bl: Coordinates (X, Y) of grid bottom-left corner in micrometres.
    :param size: Dimensions of grid (width X height) in micrometres.
    :param inst_pad_x: Padding between individual grid instances on the X axis in micrometres.
    :param inst_pad_y: Padding between grid rows (on the Y axis) in micrometres.
    """
    name: str
    coord_bl: Tuple[int, int]
    size: int
    inst_pad_x: int
    inst_pad_y: int
...
class Macro:
    ...
    :param grid_autoplace_attach: If defined, this macro and its instances will be autoplaced into the grid
    with the name specified. See Odb.GridMacroAutoplacer.
    """
    ...
    grid_autoplace_attach: Optional[str] = None
